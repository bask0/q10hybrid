...
class Objective(object):
    ...
    def __call__(self, trial: optuna.trial.Trial) -> float:
        ...
        weight_decay = 0.
        ta_revert = trial.suggest_categorical('ta_revert', [True, False])
    ...
    def add_project_specific_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        parser.add_argument(
            '--log_dir', default='./logs/experiment_03/', type=str)
        return parser
...
def main():
    ...
    if args.new_study | args.restart | (not os.path.isdir(args.log_dir)):
